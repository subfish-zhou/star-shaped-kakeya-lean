...
/-!
# Frozen high-tail ledgers for the 3527/50000 witness
...
def highRadiusLower : ℝ := 201980829 / 200000000
...
/-- The high-tail certificate also dominates the exact minimum low surrogate,
so no short common coefficient is needed in the final headline. -/
theorem certifiedCoefficient_le_highPaymentLower :
    certifiedCoefficient ≤ highPaymentLower := by
  norm_num [highPaymentLower, highFactorLower, highWidthLower,
    highRadiusLower, highB, highA, eta, certifiedCoefficient]
